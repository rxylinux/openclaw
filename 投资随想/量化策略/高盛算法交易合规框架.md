...
- Pre-trade risk controls: automated checks before every order is sent to market
...
- Incident response plan: what to do when algorithm malfunctions or causes unintended trades
