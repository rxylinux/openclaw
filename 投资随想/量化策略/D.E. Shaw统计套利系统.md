...
- Cointegration testing: Engle-Granger and Johansen tests to verify pair relationship is real
- Spread calculation: how to measure the price difference between paired securities correctly
- Z-score signal generation: when to spread deviates enough from normal to trigger a trade
...
- Mean reversion speed analysis: how quickly to spread typically returns to normal
...
这是一个 D.E. Shaw 风格的统计套利系统框架，用于构建配对交易策略。

### 使用方法

将 `[DESCRIBE YOUR PREFERRED SECTOR OR MARKET, AVAILABLE DATA, TRADING CAPITAL, AND EXPERIENCE WITH PAIRS TRADING]` 替换为你的具体情况，例如：

```
My market: US technology sector, 5 years daily price/volume data, $50M capital, 3 years experience with statistical arbitrage and mean reversion strategies.
```
