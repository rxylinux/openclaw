...
class TechRSSFetcher:
    ...
    def __init__(self):
        ...
        self.rss_sources = [
            ...
            },
            {
                ...
                'category': '深度科技',
                'description': '深度科技报道、前沿技术',
                'limit': 4
            }
        ]

    def fetch_rss(self, rss_config: dict) -> dict:
        """
        获取单个 RSS 源
        ...
        try:
            ...
            for entry in feed.entries[:rss_config['limit']]:
                # 提取并清理摘要
    ...
    def fetch_all(self) -> list:
        ...
        for rss_config in self.rss_sources:
            ...
            result = self.fetch_rss(rss_config)
...
def save_report(results: list, output_path: str):
    ...
    filename = f"tech_rss_summary_{timestamp}.md"
...
def main():
    ...
    output_dir = "/root/.openclaw/workspace/temp/tech-rss-articles"
